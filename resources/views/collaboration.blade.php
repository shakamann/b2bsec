	...
	<section class="sec2 bckg3">
		<div class="container">
			...
			<!-- Financial Terms -->
				...
				<h4><i>- Alibaba</i></h4>
				<ul class="ft">
					<li>We will require a consultancy fee of USD350, 000.00(negotiable) made payable to bank account information provided by Kennethetal. Such consultancy fee will serve to show Alibaba's commitment to the dexpose project and will help kennethetal discharge outstanding debts to field researches, as well as maintain an enabling environment for reporting from Nigeria (home country of kennethetal) by field researchers during the course of the project in China or other region chosen by Alibaba.</li>
					<li>Note: Alibaba will receive a White Paper from Kennethetal on the Subject Matter of; <i>"Email Security Awareness for B2b Transactions"</i>.</li>
